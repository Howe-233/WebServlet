<%@ page import="com.hzlx.entity.UserInfoPojo" %>
<%--
    ...
    <div class="lyear-layout-container">
        ...
        <aside class="lyear-layout-sidebar">
            ...
            <div id="logo" class="sidebar-header">
                <a href="#top"><img src="${ctx}/static/bootstrap/images/logo-sidebar.png" title="LightYear"
                                    alt="LightYear"/></a>
            </div>
                        ...
                        <c:forEach var="menu" items="${menuList}">
                            ...
                            <li
                                    <c:if test="${not empty menu.list}">
                                        class="nav-item nav-item-has-subnav <c:if test="${menu.id == 2}"></c:if>"
                                    </c:if>
                            ...
                            >
                                ...
                                <c:if test="${not empty menu.list}">
                                    <ul class="nav nav-subnav">
                                            ...
                                            <%--                                            <li><a --%>
                                            <%--                                                    <c:if test="${menuItem.href}"> href="${ctx}${menuItem.href}" </c:if> --%>
                                            <%--                                                >${menuItem.title}</a>--%>
                                            <%--                                            </li>--%>
                                            <%--                                        </c:forEach>--%>
                                        <c:forEach var="menuItem" items="${menu.list}">
